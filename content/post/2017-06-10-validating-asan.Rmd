...
We should see the same output as above with a slight exception.
...
We've now validated that the address sanitizer is installed and functioning as expected.
We should now be able to proceed to test our own code.
